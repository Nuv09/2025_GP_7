  ...
  Widget _buildImageSection(BuildContext context, double maxSize) {
    ...
    return SlideTransition(
      ...
      child: FadeTransition(
        ...
        child: SizedBox(
          width: size * 2.2, // ← زيادة عرض المساحة
          height: size * 1.9, // ← زيادة المساحة الرأسية
          child: Stack(
            alignment: Alignment.center,
            children: [
              // دائرة اليسار
              Positioned(
                left: size * 0.10, // ← كانت 0 → الآن أبعد
                top: size * 0.60, // ← مسافة أكبر بين الصور
                child: _circleImage("assets/images/about1.png", size),
              ),

              // دائرة اليمين
              Positioned(
                right: size * 0.13, // ← نفس اليسار للموازنة
                top: size * 0.60,
                child: _circleImage("assets/images/about2.png", size),
              ),

              // دائرة الوسط
              Positioned(
                top: size * 0.10, // ← رفعناها فوق شوي
                child: _circleImage("assets/images/about3.png", size),
              ),
            ],
          ),
        ),
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                textAlign: TextAlign.right,
                style: GoogleFonts.almarai(
                  color: kLightBeige.withOpacity(0.7), // لون فاتح لنص المحتوى
                  height: 1.7,
                  fontSize: 17,
                ),
              ),
