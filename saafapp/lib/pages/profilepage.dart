...
class _ProfilePageState extends State<ProfilePage> {
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(
                  colors: [kGold.withValues(alpha: 0.25), Colors.transparent],
                  stops: const [0.0, 1.0],
                ),
              ),
            ),
  ...
  Widget _clickableAvatar() {
    ...
    return Stack(
      ...
      children: [
        ...
        // زر الحذف - يظهر فقط في حالة وجود صورة شخصية مرفوعة
        if (hasImage)
          Positioned(
            top: 2,
            left: 2,
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      await u.updatePhotoURL(newPhoto);
                ...
                children: [
                  ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      if (password.isEmpty) {
                        setDialogState(
                          () => localError = "الرجاء إدخال كلمة المرور",
                        );
                        return;
                      }
                      try {
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      data: Theme.of(context).copyWith(
        textSelectionTheme: TextSelectionThemeData(
          cursorColor: kGold,
          selectionColor: kGold.withValues(alpha: 0.40),
          selectionHandleColor: kGold,
        ),
      ),
      child: Scaffold(
