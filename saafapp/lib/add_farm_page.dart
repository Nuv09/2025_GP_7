...
class _AddFarmPageState extends State<AddFarmPage> {
  ...
  double _bottomSafeInset(BuildContext ctx) =>
      kBottomNavigationBarHeight + MediaQuery.of(ctx).padding.bottom + 12;
        ...
        body: SingleChildScrollView(
          child: Padding(
            padding: EdgeInsets.fromLTRB(
              ...
              16,
              16,
              16 + _bottomSafeInset(context), // <<< CHANGED
            ), // << كان ثابت
            child: Column(
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: GoogleFonts.almarai(color: Colors.white54),
  ...
  // * بناء زر الإضافة
  // -----------------------------------------------------------------------------
  // --- [استبدال كامل الدالة] نفس ستايل زر "ابدأ الآن" ---
  Widget _buildSubmitButton() {
    return SizedBox(
      height: 54, // نفس ارتفاع زر "ابدأ الآن"
      child: DecoratedBox(
        decoration: BoxDecoration(
          // نفس التدرّج المستخدم في زر "ابدأ الآن"
        ...
        child: Material(
          ...
          child: InkWell(
            borderRadius: BorderRadius.circular(14), // مطابق لزر "ابدأ الآن"
            onTap: _isLoading ? null : _submitFarmData,
            child: Center(
              child: _isLoading
                  ? const SizedBox(
                      width: 22,
                      ...
                      child: CircularProgressIndicator(
                        strokeWidth: 3,
                        color: Color(0xFF042C25), // kDeepGreen
                      ),
                    )
                  : Text(
                      'إضافة المزرعة',
